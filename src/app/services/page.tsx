...
import { ArrowLeftRight, PackageSearch, ShoppingCart, Wrench, Microscope, Scaling, FileCheck } from 'lucide-react';
    ...
    <div className="container py-16 md:py-24">
      ...
      <div className="space-y-12">
        {services.map((service, index) => (
          <Card key={service.title} className="overflow-hidden shadow-lg border-l-4 border-primary">
            <div className="grid md:grid-cols-3">
              <div className="p-8 bg-secondary/30 flex flex-col justify-center items-center md:items-start text-center md:text-left">
                  {service.icon}
              ...
              <div className="md:col-span-2 p-8">
                <Accordion type="single" collapsible className="w-full">
                  {service.details.map((detail, i) => (
                     <AccordionItem value={`item-${index}-${i}`} key={i}>
