                            ...
                            {invoice.items.map((item, index) => {
                                ...
                                return (
                                    <tr key={index} className="border-b">
                                        ...
                                        <td className="p-2 border"><p className="font-bold leading-tight">{item.description}</p></td>
                                        <td className="p-2 text-center border">{item.quantity}</td>
                                        <td className="p-2 text-right border">{renderPrice(item.unitPrice, manualEur || (item.unitPrice * invoiceRate))}</td>
                                        <td className="p-2 text-right border font-bold">{renderPrice(Number(item.quantity) * Number(item.unitPrice), lineEur)}</td>
                                    </tr>
                                )
                            })}
                        </tbody>
